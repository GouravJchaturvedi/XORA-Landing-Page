    ...
    <header className="fixed top-0 left-0 z-50 w-full py-10">
      <div className="container flex h-14 items-center max-lg:px-5">
        <a className="lg:hidden flex-1 cursor-pointer z-2">
          <img
            src="https://xora-saas-landing-page.in/images/xora.svg"
            alt="Logo"
            width={115}
            height={55}
          />
        ...
        <div className={clsx('w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0' , isOpen ? 'max-lg:opacity-100' : 'max-lg:pointer-events-none')}>
          <div className="max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            ...
            <div className="lg:hidden absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290] -translate-y-1/2 rotate-90">
                <img src="	https://xora-saas-landing-page.in/images/bg-outlines.svg" alt="outline" height={380} width={960} className="relative z-2"/>
                <img src="	https://xora-saas-landing-page.in/images/bg-outlines-fill.png" alt="outline" height={380} width={960} className="absolute inset-0 mix-blend-soft-light opacity-5"/>
            </div>
          </div>
        </div>
        <button className="lg:hidden z-2 size-10 border-2 border-s4/25 rounded-full flex justify-center items-center" onClick={() => setIsOpen(!isOpen)}>
          <img
            src={`https://xora-saas-landing-page.in/images/${isOpen ? 'close' : 'magic'}.svg`}
            alt="button"
